...
public class CutterParticleCollisionSystem : JobComponentSystem
{
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        {
            dstManager = dstManager.CreateCommandBuffer().AsParallelWriter(),
            //jobHandle = inputDeps,
    ...
    {
        public EntityCommandBuffer.ParallelWriter dstManager;
        ...
        public void Execute(TriggerEvent triggerEvent)
        {
            ...
            particle = triggerEvent.EntityA;
            //otherCollider = triggerEvent.EntityB;

            dstManager.SetComponent(0, particle, new PhysicsVelocity { });
        }
    }
}